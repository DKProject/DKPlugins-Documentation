...
## **Compatibility**
DKPerms supports minecraft 1.8 - 1.16.4 and runs on all McNative supported platforms:
...
DKPerms supports java 8 - 15 and requires a stabl internet connection (DKPerms downloads all necessary libraries dynamically). 
