...
## Suggestions
If you have a great idea that should be implemented in DKSupport. Feel free to create a suggestion.
We use the Feedbacky platform to collect and vote for suggestions.

[Create a new Idea](https://feedbacky.pretronic.net/b/dksupport)
