...
final String GIT_DOCS_SSH = "git@github.com:DKProject/DKPlugins-Documentation.git"

final String CI_NAME = "PretronicCI"
final String CI_EMAIL = "ci@pretronic.net"

final String CNAME = "dkplugins.pretronic.net"

final String PROJECT_NAME = "DKPlugins-Documentation"
        ...
        stage('Install pip packages') {
            steps {
                script {
                    ...
                    pip install -U mkdocs-git-committers-plugin-2
                    """
                }
            }
        }
